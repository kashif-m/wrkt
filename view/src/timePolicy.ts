...
export const roundToLocalDay = (timestampMs: number, offsetMinutes = getLocalOffsetMinutes()) => {
...
export const roundToLocalWeek = (timestampMs: number, offsetMinutes = getLocalOffsetMinutes()) => {
...
export const sortEventsByDeterministicOrder = <T extends { ts?: number; event_id?: string }>(events: T[]) =>
  [...events].sort((a, b) => {
